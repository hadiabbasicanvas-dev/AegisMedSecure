...
import { ThreatTimelineEventItem } from '@/services/threatService';
import { formatDate } from '@/utils/formatters';
import { ShieldCheck, Cpu, User, AlertOctagon } from 'lucide-react';

interface ThreatTimelineProps {
  events: ThreatTimelineEventItem[];
}
  ...
  return (
    <div className="space-y-6">
      <h3 className="text-sm font-bold text-slate-100 uppercase tracking-wider font-mono flex items-center gap-2">
        <AlertOctagon className="h-4 w-4 text-cyan-400" /> Threat Investigation Audit Timeline
      </h3>
